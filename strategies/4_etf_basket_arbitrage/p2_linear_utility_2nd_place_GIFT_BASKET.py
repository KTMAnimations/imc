"""
IMC Prosperity 2 - Team Linear Utility (2nd Place Global)
Round 3: Gift Basket Spread Trading (Mean-Reversion with Z-Score)
Source: https://github.com/ericcccsliu/imc-prosperity-2/blob/main/round3/round3_v2.py

Strategy:
- Computes synthetic basket price = 4*CHOCOLATE + 6*STRAWBERRIES + 1*ROSES
- Calculates spread = GIFT_BASKET - synthetic
- Tracks rolling spread history and computes z-score
- When z-score exceeds threshold (7): sell basket, buy constituents
- When z-score below -threshold: buy basket, sell constituents
- Converts synthetic basket orders into individual component orders
- Hedges basket exposure with individual constituents
"""
