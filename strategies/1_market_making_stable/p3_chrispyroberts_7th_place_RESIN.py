"""
IMC Prosperity 3 - Round 1 Final Trading Algorithm
Team: chrispyroberts (7th Global, 1st USA)
Source: https://github.com/chrispyroberts/imc-prosperity-3
File: ROUND 1/final_round_1_trader.py

Products: RAINFOREST_RESIN (stable, fair value = 10000), KELP (dynamic), SQUID_INK (volatile)
Key Strategy for RAINFOREST_RESIN:
- Hardcoded fair value of 10000
- Take all asks below 10000, take all bids above 10000
- Penny competing market makers (bid = their_bid + 1, ask = their_ask - 1)
- Default spread: 9996-10004 when no competition
- Inventory flattening: at fair value when position is on wrong side
"""
