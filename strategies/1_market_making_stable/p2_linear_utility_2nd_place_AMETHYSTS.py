...
Team: Linear Utility (2nd Place Overall)
...
Key Strategy:
- AMETHYSTS: Hardcoded fair value 10000, take/clear/make three-phase approach
- Three phases: (1) Take favorable orders, (2) Clear inventory at fair, (3) Make passive quotes
- Pennying and joining logic for passive quoting
- Soft position limit to manage inventory risk
"""
