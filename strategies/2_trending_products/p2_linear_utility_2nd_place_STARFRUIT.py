"""
SOURCE: Team Linear Utility - 2nd Place IMC Prosperity 2
REPO: https://github.com/ericcccsliu/imc-prosperity-2
FILE: round1/round_1_v6.py
PRODUCT: STARFRUIT (trending/drifting product in Prosperity 2)

KEY TECHNIQUES FOR TRENDING PRODUCTS:
- Identifies "market maker mid" by filtering for large orders (adverse_volume >= 15)
  to find the persistent MM whose quotes define fair value
- Mean reversion signal: tracks last price, computes returns, applies reversion_beta (-0.229)
  to predict next-step fair value adjustment
- Adverse selection protection: prevents taking against informed flow (large orders)
- Three-phase order logic: Take -> Clear -> Make
- Pennying and joining logic for passive order placement
"""
