"""
v5j: Add a constant offset to fair. fair = wall_mid_EMA + offset.
Higher offset = fewer take sells (good when market drifts up).
But that's overfit to upward drift...
"""
...
class Trader:
    ...
    def tomatoes_fair(self, od, pos, trader_data):
        ...
        fair = ema - TOMATOES_INV_SKEW * pos + TOMATOES_FAIR_OFFSET
