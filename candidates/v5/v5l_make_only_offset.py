"""
v5l: Apply offset ONLY to make quote prices (max_bid/min_ask).
"""
...
class Trader:
    ...
    def tomatoes_quote_prices(self, od, fair, eff_pos):
        ...
        # Apply offset to fair used here
        f = fair + TOMATOES_MAKE_OFFSET
        max_bid = math.ceil(f) - 1
        min_ask = math.floor(f) + 1
