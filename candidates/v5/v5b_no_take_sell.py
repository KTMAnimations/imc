"""
v5b: NO TOMATOES take sells. The take sell phase loses 1097 in sim_gui
on the 17-log set due to upward drift (avg sell 4990 < final mid 4996.5).
Test: does removing them help (sim_gui upper bound), or break the strategy?
"""
