"""
v5k: Apply offset ONLY to take threshold, not to make/clear/quote prices.
"""
...
class Trader:
    ...
    def tomatoes_take(self, od, fair, pos, bv, sv):
        ...
        take_fair = fair + TOMATOES_TAKE_OFFSET
        for ask in sorted(od.sell_orders.keys()):
