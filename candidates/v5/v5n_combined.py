"""
v5n: Take at ask < max(fair, wall_mid). EMA fair is conservative/smoothed.
...
class Trader:
    ...
    def tomatoes_take(self, od, fair, take_ref, pos, bv, sv):
        ...
        buy_threshold = take_ref  # use wall_mid directly
        sell_threshold = take_ref  # use wall_mid directly
        for ask in sorted(od.sell_orders.keys()):
