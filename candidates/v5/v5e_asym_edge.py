"""
v5e: Asymmetric take edges. Take sells require a LARGER edge than take buys.
"""
...
TOMATOES_BUY_EDGE = 0.0  # take ask < fair - this
TOMATOES_SELL_EDGE = 1.0  # take bid > fair + this
...
class Trader:
    ...
    def tomatoes_take(self, od, fair, pos, bv, sv):
        orders = []
        buy_threshold = fair - TOMATOES_BUY_EDGE
        sell_threshold = fair + TOMATOES_SELL_EDGE
        for ask in sorted(od.sell_orders.keys()):
            if ask >= buy_threshold: break
